...
import { Box, Typography, Badge, Table, TableBody,TableRow, TableCell } from '@mui/material'
            ...
            <Table>
                <TableBody>
                    <TableRow className={classes.smallText}>
                        ...
                        <TableCell style={{ fontWeight: 600 }}>Delivery by 88 dec | ₹40</TableCell>
                    </TableRow>
                    <TableRow className={classes.smallText}>
                    ...
                    <TableRow className={classes.smallText}>
                        ...
                        <TableCell>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatum dolor perferendis cupiditate id iusto nostrum fuga laborum quisquam, quia</TableCell>
                    </TableRow>
                </TableBody>
            </Table>
